...
figure(1)
pl1 = plot(ymutime, 'Color', [0.9 0.9 0.9],'DisplayName','rmin = 0.1')
...
figure(1)
pl2 = plot(ymutime, 'Color',[0.8 0.8 0.8],'DisplayName','rmin = 0.5')
...
figure(1)
pl3 = plot(ymutime, 'Color',[0.6 0.6 0.6],'DisplayName','rmin = 0.9')
...
figure(1)
pl4 = plot(ymutime, 'Color', [0.4 0.4 0.4],'DisplayName','rmin = 1.5')
...
figure(1)
pl5 = plot(ymutime, 'Color', [0 0 0],'DisplayName','rmin = 2')

xlabel('time')
ylabel({'Chorus mean syllable rate';'Zbar'})
hold off
legend('show')