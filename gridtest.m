...
mut = 0.05;
k = 10^5;
rmini = [0.1 0.2 0.25 0.3 0.4 0.5 ];
rmaxi = [2.5 2.6 2.7 2.8 2.9 3];
rminout = zeros(6,6);
rminout2 = zeros(6,6);
rmaxout = zeros(6,6);
rmaxout2 = zeros(6,6);
...
mut = 0.05;
k = 10^5;
rmini = [0.80 0.82 0.84 0.86 0.88 0.9];
rmaxi = [2.5 2.6 2.7 2.8 2.9 3];
rminout = zeros(6,6);
rminout2 = zeros(6,6);
rmaxout = zeros(6,6);
...
k = 10^5;
rmini = [0.1 0.2 0.25 0.3 0.4 0.5];
rmaxi = [1.9 1.92 1.94 1.96 1.98 2];
rminout = zeros(6,6);
rminout2 = zeros(6,6);
rmaxout = zeros(6,6);
rmaxout2 = zeros(6,6);
...
k = 10^5;
rmini = [0.1 0.2 0.25 0.3 0.4 0.5];
rmaxi = [1.1 1.2 1.25 1.3 1.4 1.5];
rminout = zeros(6,6);
rminout2 = zeros(6,6);
rmaxout = zeros(6,6);
rmaxout2 = zeros(6,6);
