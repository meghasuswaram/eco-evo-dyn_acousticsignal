...
figure(4)
h = heatmap(rmini, rmaxi, rminoutn); %heatmap
...
figure(5)
h = heatmap(rmini, rmaxi, rminout2n); %heatmapavgs
h.YDisplayData = flipud(h.YDisplayData);  % equivalent to 'YDir', 'Reverse'
% ddd=[0 0 0;summer(100)];
% colormap(ddd);
colorbar
...
figure(6)  %heatmapstdv
h = heatmap(rmini, rmaxi, test1)%rminout3n);
h.YDisplayData = flipud(h.YDisplayData);  % equivalent to 'YDir', 'Reverse'
% ddd=[0 0 0;summer(100)];
% colormap(ddd);
colorbar
